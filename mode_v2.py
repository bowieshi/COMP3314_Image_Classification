...
for image_name in image_names:
    ...
    raw_feature = image.flatten()
    HOG_feature = HOG_FeatureExtractor(image)
    TopColor_feature = TopColors_FeatureExtractor(image, 3)
    ...
    features = np.concatenate((HOG_feature, TopColor_feature), axis=0)
...
gamma = "auto"
model = SVC(kernel='rbf', max_iter=3000, gamma="auto")
